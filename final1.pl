...
# Team:       TahD
# Date:       2025-08-27
# Version:    1.6.2 (final, batch-only, readable)
#
# How it works:
...
# Verify single pair (after macro) — no "not re-verified" wording anymore
sub verify_pair_once {
    ...
    # Snapshot nie potwierdza zmiany — traktujemy jako ostrzeżenie,
    # ale NIE używamy frazy "not re-verified".
